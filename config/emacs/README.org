...
- When I will actually finalize this new variant I don't know but you have been warned that the config is changing check the =legacy-backup= branch for the old config
** 12/21/2023
