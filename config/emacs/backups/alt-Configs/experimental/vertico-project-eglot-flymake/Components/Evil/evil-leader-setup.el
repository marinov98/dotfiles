...
(use-package general
  ...
  (mpm/leader-keys
    ...
    "c s" '(shell :wk "Shell")
    "c f" '(:ignore t :wk "Flymake options")
    "c f m" '(flymake-mode :wk "Flymake mode")
    "c f d" '(flymake-disabled-backends :wk "Flymake disabled backends")
    "c f M" '(flymake-menu :wk "Flymake menu")
    "c f v" '(flymake-running-backends :wk "Flymake running backends")
    "c f l" '(consult-flymake :which-key "Flymake list errors (Consult)"))
