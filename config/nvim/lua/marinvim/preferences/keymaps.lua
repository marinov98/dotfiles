...
vim.keymap.set("n", "<leader>cm", ":%s//gc<Left><Left><Left>",
  { desc = "Search/replace in current file with confirmation" })     -- attempt at native multiple cursors
vim.keymap.set("v", "<leader>cm", ":s//gc<Left><Left><Left>",
  { desc = "Search/replace in visual highlight with confirmation" }) -- attempt at native multiple cursors visual mode
