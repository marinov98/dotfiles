...
- Remapped some bindings to make them work better with autocomplete
...
(use-package yasnippet
    ...
    ("<tab>" . nil) ;; while this is convinient, it clashes with auto-complete and jump-to-definitions
    ("<C-tab>" . yas-expand)))
    :init 
    (yas-global-mode 1))
...
#+BEGIN_SRC emacs-lisp
  (use-package company
      ...
      (setq company-idle-delay 0.15) ;; slightly delay completions
