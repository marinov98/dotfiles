...
#+begin_src emacs-lisp
  (when (string-equal system-type "gnu/linux") 
    (setq
      ...
      ("." . browse-url-chromium))))
#+end_src
MS-Windows can be slow and can give a lot of issues. This setting below at least fixes the issue of it not recognizing unicode characters and not letting you save your file.
#+begin_src emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package evil
      ...
      ;; Fixes
      (evil-set-initial-state 'ivy-occur-grep-mode 'normal) ;; wgrep and ivy temp fixes
      (setq evil-emacs-state-modes (delq 'ibuffer-mode evil-emacs-state-modes)) ;; ibuffer start in evil mode instead of emacs mode
