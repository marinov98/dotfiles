...
** Inspiration:
- I became inspired to write this as an actual guide rather just a config reference file, after I configured my emacs to the point where I could comftorably write C++, Python, and JavaScript code as well as take notes in Org mode.
** Purpose:
