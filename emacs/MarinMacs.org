...
* Buffer-Switching
 ...
 - Still a used these for a while as a vim user before I discovered the evil leader package.
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (use-package company
      ...
      ("M-j" . company-select-next)  ;; also make C-j new selection key
...
*** Projectile (project management)
  - Projectile also has support for popular search tools:
