...
#+begin_src emacs-lisp
  (when (string-equal system-type "gnu/linux") 
    (setq
      ...
      ("." . browse-url-chromium))))
#+end_src
Windows can be slow and can give a lot of issues. This setting below at least fixes the issue of it not recognizing unicode characters and not letting you save your file.
#+begin_src emacs-lisp
