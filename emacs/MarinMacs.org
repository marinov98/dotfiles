...
#+BEGIN_SRC emacs-lisp
  ...
  (defhydra hydra-zoom (global-map "<f2>" :color pink)
   ...
   ;; projectile
  (defhydra hydra-projectile (global-map "S-SPC" :color pink)
    "Counsel Projectile 🚀"
    ("f" counsel-projectile-find-file "find")
    ("F" counsel-projectile-find-file-dwin "find-dwin")
  ...
  (defhydra hydra-window (global-map "M-SPC" :color pink)
   "⚡ Ivy/Windows ⚡"
...
- This is purely experimental and will not be included in the guide until I feel like I know how to use it
- Repo: https://github.com/emacs-lsp/dap-mode#configuration
#+BEGIN_SRC emacs-lisp
