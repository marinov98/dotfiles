...
#+BEGIN_SRC emacs-lisp
  (use-package general
    ...
    (mpm/leader-keys
       ...
       "a" '(hydra-avy-snipe/body :wk "LSP Hydra")
    ...
    (mpm/leader-keys
      ...
      "t r" '(:ignore t :wk "Treemacs Rename Options")
      "t r f" '(treemacs-rename-file :wk "Treemacs rename file")
      "t r w" '(treemacs-rename-workspace :wk "Treemacs rename workspace")
      "t r p" '(treemacs-rename-project :wk "Treemacs rename project")))
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; like vim-sneak and/or vim-seek
...
#+BEGIN_SRC emacs-lisp
  (pretty-hydra-define hydra-code (:color red :title "📡 Code 📡" :quit-key "q") 
    ...
    ("P" lsp-ui-peek-find-definitions "peek def")
...
#+END_SRC
*** Sharpshooter (Avy + Snipe)
#+BEGIN_SRC emacs-lisp
  (pretty-hydra-define hydra-avy-snipe (:color blue :title "↵ Avy + Snipe ↵" :quit-key "q")
    ("Char"
    (("c" avy-goto-char "char 1" :color red)
    ("f" avy-goto-char-2 "char 2" :color red)
    ("s" evil-snipe-s "(snipe) char 2" :color red)
    ("S" evil-snipe-S "(snipe) goto char 2 eol" :color red)
