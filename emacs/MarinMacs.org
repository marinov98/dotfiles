...
#+BEGIN_SRC emacs-lisp
  ;; multiple cursors
   (defhydra hydra-mc (global-map "C-c m" :color pink :columns 3)
      ...
      ("f"  evil-mc-make-and-goto-first-cursor "first cursor")
      ("l"  evil-mc-make-and-goto-last-cursor "last cursor")
      ("P"  evil-mc-make-and-goto-prev-cursor "go next")
      ("N"  evil-mc-make-and-goto-next-cursor "go prev")
      ("a"  evil-mc-make-all-cursors "all")
      ("q"  evil-mc-undo-all-cursors "quit" :color blue))
#+END_SRC
*** projectile (utilize counsel projectile)
#+BEGIN_SRC emacs-lisp
