...
#+BEGIN_SRC emacs-lisp
      (use-package general
       ...
       (mpm/leader-keys
          ...
          "w" '(hydra-nav/body :wk "Window Nav Hydra")
       ...
       (mpm/leader-keys
          ...
          "i f" '(counsel-fzf :wk "Counsel Git") 
...
#+BEGIN_SRC emacs-lisp
  (pretty-hydra-define hydra-nav (:color blue :title "⚡ Window Nav ⚡" :quit-key "q") 
    ("Split"
