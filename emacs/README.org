...
- Reference =alt-Configs= for either more minimal or alternative implementations of my config (I currently use Ivy but I have a helm version of my configuration as well)
* Contact
