...
- Helm-ls-git: provoides =helm-browse-projects= which allows you search following your gitignore
...
the vim package =easymotion= really boosts your ability to fly around text even with vim keybindings. I utilize the keybinds in a hydra and a personal keybinding just becauses its soo good. 
#+BEGIN_SRC emacs-lisp
  (use-package avy 
      :ensure t
      :custom
