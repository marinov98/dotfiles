...
#+BEGIN_SRC emacs-lisp
  (use-package evil-leader
      ...
      (evil-leader/set-key
        ...
        "i" 'helm-swoop ;; think of it as isearch counsin to remember keybinding 
        "m" 'helm-multi-swoop
...
- Helm-rg: uses ripgrep with helm frontend to find matches (has errors so I am using deadgrep instead)
- Helm-ag: uses silversearcher with helm frontend to find matches
- Helm-ls-git: allows you search following your gitignore
- Helm-swoop: listing line matches similiar to swiper
  #+begin_src emacs-lisp
    (use-package helm
        :ensure t
        :diminish
