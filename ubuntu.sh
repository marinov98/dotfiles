...
npm i -g tern jquery eslint @fortawesome/free-solid-svg-icons http-server sequelize-cli react react-dom create-react-app prop-types requirejs typescript express angular reactrap webpack @angular/core
