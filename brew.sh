...
brew install pip 
brew install clang-format gcc ctags aspell cmake yarn node npm gdb neofetch 
brew install node npm gdb neofetch karabiner karabiner karabiner-elements pyenv pyenv-virtualenv pyenv-virtualenvwrapper
