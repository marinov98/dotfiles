...
npm i -g core-js nodemon express-generator tern pg jquery bootstrap prettier @fortawesome/free-solid-svg-icons sequelize-cli eslint heroku angular @angular/cli http-server react react-dom create-react-app prop-types express @angular/core typescript tslint requirejs reactstrap webpack console-info console-warn console-error
